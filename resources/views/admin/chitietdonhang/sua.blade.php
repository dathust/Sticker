                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <h1 class="page-header">Chi Tiết Đơn Hàng
                            <small>Sửa đơn hàng số {!!$chitietdonhang->id!!}</small>
                        </h1>
                    </div>
                    <!-- /.col-lg-12 -->
                    ...
                    @endif
                         <form action="admin/chitietdonhang/sua/{{$chitietdonhang->id}}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="idLoaigiay" id="Loaigiay">
