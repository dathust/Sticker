                    ...
                    @endif
                        ...
                        <input type="hidden" name="_token" value="{{csrf_token()}}" />
                          ...
                          <div class="form-group">
                                ...
                                <input class="form-control" name="acc" placeholder="Nhập tài khoản" value="{{$user->acc}}" readonly="" />                                         
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <label class="radio-inline">
                                    <input type="radio" name="quyen" value="0" checked="">Khách hàng
                                </label>
