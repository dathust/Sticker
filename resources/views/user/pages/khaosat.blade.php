  ...
  <section id="product">
    ...
    <form action="khao-sat" method="POST">
      <input type="hidden" name="_token" value="{{csrf_token()}}" />
        ...
        <div class="row">
          <h1 class="heading1"><span class="maintext">Khảo sát khách hàng</span><span class="subtext"></span></h1>
        ...
        <!-- Sidebar End-->
          ...
          <br>
       <button type="submit" class="btn btn-default"><h3>Hoàn tất</h3></button>
